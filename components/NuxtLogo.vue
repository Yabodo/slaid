<template>
  <div class="flex items-top justify-center items-center">
    <svg xmlns="http://www.w3.org/2000/svg" class="nuxt-logo color-white fill-blue-500" viewBox="0 0 24 24" width="512" height="512">
