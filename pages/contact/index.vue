    ...
    <section class="text-gray-600 body-font relative">
      <div class="container px-5 py-24 mx-auto">
        <div class="flex flex-col text-center w-full mb-12">
          <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Võta ühendust</h1>
          <p class="lg:w-2/3 mx-auto leading-relaxed text-base">Teinekord on ikka tore küsimused ja mõtted selgeks rääkida. Kui on soov, siis võta julgelt ühendust. Kuigi ka meil on kiire, siis anname omalt poolt parima, et teile esimesel võimalusel vastata.</p>
        </div>
        <div class="lg:w-1/2 md:w-2/3 mx-auto">
          <div class="flex flex-wrap -m-2">
            <div class="p-2 w-1/2">
              <div class="relative">
                <label for="name" class="leading-7 text-sm text-gray-600">Nimi</label>
            ...
            <div class="p-2 w-1/2">
              <div class="relative">
                <label for="email" class="leading-7 text-sm text-gray-600">E-posti aadress</label>
            ...
            <div class="p-2 w-full">
              <div class="relative">
                <label for="message" class="leading-7 text-sm text-gray-600">Sõnum</label>
            ...
            <div class="p-2 w-full">
              <button class="flex mx-auto text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">Saada</button>
            </div>
            <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
              <a class="text-blue-500">tere@slaid.ee</a>
              <p dir="rtl" class="leading-normal my-5">Kaspar
                <br>3662 5373 372+
              </p>
